Нижче наведено приклад змісту файлу README для вашого репозиторію. Ви можете скопіювати цей текст у файл README.md або використовувати його як інструкцію:
